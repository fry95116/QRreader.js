    ...
    var QRreader = function () {
        ...
        (0, _createClass3.default)(QRreader, [{
                ...
                if (util.getMediaDevices() !== null) {
                    ...
                    var doOnClick = function () {
                        var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
                            var ret, readFromFileInputOnce, isCancel;
                                ...
                                while (1) {
                                    switch (_context2.prev = _context2.next) {
                                        ...
                                        case 4:
                                            ...
                                            if (!_this2.readFromAlbum) {
                                                _context2.next = 12;
                                                break;
                                            }

                                            readFromFileInputOnce = new _promise2.default(function (resolve) {
                                                        ...
                                                        return _regenerator2.default.wrap(function _callee$(_context) {
                                                            while (1) {
                                                                switch (_context.prev = _context.next) {
                                                                    case 0:
                                                                        _this2._fileInput.removeEventListener('change', onChange);

                                                                        if (!(_this2._fileInput.files.length === 0)) {
                                                                            _context.next = 3;
                                                                            break;
                                                                        }
                                                                    ...
                                                                    case 3:
                                                                        _context.next = 5;
                                                                        return _this2._readQRcodeFromFile(_this2._fileInput.files[0]);
                                                ...
                                                _this2._fileInput.addEventListener('change', onChange);
                                            });
                                            _context2.next = 9;
                                            return _promise2.default.race([readFromFileInputOnce, _this2._startCapture()]);
                    ...
                    this._fileInput.addEventListener('change', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
                        var ret;
            ...
            value: function () {
                ...
                function _readQRcodeFromFile(_x2) {
                    return _ref4.apply(this, arguments);
                }

                return _readQRcodeFromFile;
            }()
        }, {
            key: '_setCamera',
            value: function () {
...
},{"./util.js":83,"babel-runtime/core-js/promise":2,"babel-runtime/helpers/asyncToGenerator":3,"babel-runtime/helpers/classCallCheck":4,"babel-runtime/helpers/createClass":5,"babel-runtime/regenerator":6,"jsqr":79}],83:[function(require,module,exports){
'use strict';
